<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <head>
        <title>E Guru</title>
        <link rel="stylesheet" href="/css/desktop10.css" type="text/css" />
    ...
    <body style="background-color: #D9FAFFBF;align-items: center;">
        <div class="header">
            ...
            <img id="profile" onclick="fun()" src="https://drive.google.com/uc?export=view&id=${stud.profileimg}" alt="Profile Not Found" />
        ...
        <div class="menu" id="menu">
            ...
            <h2><a href="/editstudprofile">Edit Profile</a></h2>
            <h2><a href="/studlogout">Logout</a></h2>
        </div>
        <h2 id="wel">Welcome ${stud.name}</h2>
        <h4 id="head1">Continue Learning...</h4>
        <div class="box1">
            <c:forEach items="${cres}" var="cr">
                <div class="card">
        ...
        <h4 id="head1">Enroll New Course...</h4>
        <div class="box1">
            <c:forEach items="${crs}" var="cr">
                <div class="card">
                    ...
                    <h2>${cr.name}</h2>
                    <h3>${cr.guruname}</h3><br>
                    <form action="/courseintro" method="post">
                        <input type="hidden" name="courseid" value="${cr.courseid}" />
                        <input id="submitting" style="cursor:pointer" type="submit" value="Join Course" />
                    </form>
                </div>
            </c:forEach>
        </div>
