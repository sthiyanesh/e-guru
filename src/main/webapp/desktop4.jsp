...
<head>
    <title>E Guru</title>
    <link rel="stylesheet" href="css/desktop4.css" />
...
<body style="background-color: #D9FAFFBF;">
    ...
    <div class="mainbox">
        ...
        <form action="/studprofile" method="post" style="text-align: center;">
            <label id="otp">Enter OTP</label><br>
            <input type="text" id="box1" name="otp" />
            <p id="clock"></p>
            <a id="link" href="/studverifymail?email=${email}" style="pointer-events: none;color:blue;opacity: 50%;">yet
                not received? resend otp</a><br><br>
